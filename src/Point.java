...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        /* YOUR CODE HERE */
        return new SlopeOrderCpt();
    }

    private class SlopeOrderCpt implements Comparator<Point>{
...
//        System.out.println(points.length);  
        ...
        System.out.println(points[1].compareTo(points[0]));
        System.out.println(points[1].compareTo(points[1]));
